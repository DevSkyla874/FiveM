...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        if (hasQBWeather) emit("qb-weathersync:server:setTime", args.hour, "0");
        else if (hasRenewedWeather) emit("Renewed-Weathersync:server:setTime", args.hour, "0");
        ...
        return interaction.reply({ content: `Time has been set to ${args.hour}:00`, ephemeral: false });
    },
};
